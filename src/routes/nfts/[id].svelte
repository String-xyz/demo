...
<script lang="ts">
	...
	import { process, byId } from '$lib/stores';
	...
	<div class="container px-5 py-24 mx-auto">
		<div class="lg:w-4/5 mx-auto flex flex-wrap">
			...
			<div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
				...
				<div class="flex">
					<span class="title-font font-medium text-2xl text-gray-900">{item?.price ?? 0}</span>
					<button
					...
					<div class="h-auto w-80 bg-white p-3 rounded-lg">
						...
						<button
							class="outline-none h-12 bg-orange-600 text-white mb-2 hover:bg-orange-700 rounded-lg w-1/2 cursor-pointer"
							on:click={handlePayment}>Buy</button
						>
					</div>
				</div>
			</div>
