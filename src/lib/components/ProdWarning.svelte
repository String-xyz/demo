...
<div class="modal" on:scroll|stopPropagation>
	<div class="modal-box relative">
		<div class="main flex flex-col items-center select-none w-full">
			...
			<p class="text-center">You are about to switch to testing our <span class="font-medium">real money environment</span>. Please contact support to receive a refund. If you accept the risks, you can exit this screen by pressing Esc, or clicking the exit buttons. Otherwise, please exit and switch the toggle back to Sandbox mode.</p>
